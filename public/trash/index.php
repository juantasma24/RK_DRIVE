...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        ...
        <p class="text-muted mb-0">
            <?= count($archivos) ?> archivo<?= count($archivos) != 1 ? 's' : '' ?> en papelera
        </p>
    </div>
...
<div class="alert alert-warning mb-3">
    ...
    Los archivos en la papelera se eliminan automaticamente despues de <strong>30 dias</strong>.
</div>
            ...
            <form method="POST" id="formEliminar">
                ...
                <div class="modal-body">
                    <p style="color:var(--text-secondary);">
                        ¿Eliminar <strong id="eliminar_nombre" style="color:var(--text-primary);"></strong>
                        permanentemente?
                    </p>
