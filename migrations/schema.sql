...
CREATE TABLE IF NOT EXISTS usuarios (
    ...
    puede_editar_archivos TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'Permiso para editar archivos de clientes (solo trabajadores)',
    puede_eliminar_archivos TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'Permiso para eliminar archivos de clientes (solo trabajadores)',
